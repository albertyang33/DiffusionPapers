...
1. **Modeling and predicting retweeting dynamics on microblogging platforms.**
*S. Gao, J. Ma, and Z. Chen.*
 WSDM 2015.
[paper](http://www.pharm.sdu.edu.cn/__local/C/5F/03/728E012F5BB112F64B7A1E21F97_54E8E2A6_ECAD2.pdf)
1. **From micro to macro: Uncovering and predicting information cascading process with behavioral dynamics.**
...
1. **Learning social network embeddings for predicting information diffusion.**
...
1. **Predicting successful memes using network and community structure.**
*L. Weng, F. Menczer, and Y.-Y. Ahn.*
 ICWSM 2014.
[paper](https://www.aaai.org/ocs/index.php/ICWSM/ICWSM14/paper/viewFile/8081/8154)
1. **Uncovering the structure and temporal dynamics of information propagation.**
*M. G. Rodriguez, J. Leskovec, D. Balduzzi, and B. Scholkopf.*
 NetSci 2014.
[paper](http://doc.rero.ch/record/300832/files/S2050124214000034.pdf)
1. **Mmrate: inferring multi-aspect diffusion networks with multi-pattern cascades.**
...
1. **Structure and dynamics of information pathways in online media.**
*M. Gomez Rodriguez, J. Leskovec, and B. Scholkopf.*
 WSDM 2013.
[paper](https://cs.stanford.edu/~jure/pubs/infopath-wsdm13.pdf)
1. **Using early view patterns to predict the popularity of youtube videos.**
*H. Pinto, J. M. Almeida, and M. A. Gonc¸alves.*
 WSDM 2013.
[paper](https://arxiv.org/pdf/1212.1464.pdf)
1. **What’s in a hashtag?: content basedprediction of the spread of ideas in microblogging communities.**
*O. Tsur, A. Rappoport.*
 WSDM 2012.
...
1. **On the convexity of latent social network inference.**
*S. Myers and J. Leskovec.*
 NIPS 2010.
[paper](https://papers.nips.cc/paper/4113-on-the-convexity-of-latent-social-network-inference.pdf)
1. **Learning  continuous-time information diffusion model for social behavioral data analysis.**
...
1. **Prediction of information diffusion probabilities for independent cascade model.**
*K. Saito, R. Nakano, and M. Kimura.*
 KES 2008.
[paper](https://link.springer.com/chapter/10.1007/978-3-540-85567-5_9)
1. **Information diffusion through blogspace.**
...
1. **Talk of the network:A complex systems look at the underlying process of word-ofmouth.**
